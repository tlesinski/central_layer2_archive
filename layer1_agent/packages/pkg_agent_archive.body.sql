CREATE OR REPLACE PACKAGE BODY PKG_AGENT_ARCHIVE
AS
  /*
    ...
    Prerequisite : AGENT_PARTITION_INFO_OBJ, AGENT_PARTITION_INFO_TAB
  ...
  */
  ...
  RETURN AGENT_PARTITION_INFO_TAB PIPELINED
  IS
    l_partition_high_value    LONG;
    l_subpartition_high_value LONG;
    l_row                     AGENT_PARTITION_INFO_OBJ :=
                                AGENT_PARTITION_INFO_OBJ(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
