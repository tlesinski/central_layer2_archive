CREATE OR REPLACE EDITIONABLE PACKAGE BODY PKG_ARCHIVER_TL_LOGGING AS
  ...
  /*
    ...
    Prerequisite : TBL_ARCHIVER_PROCESS_LOG, ARCHIVER_PROCESS_LOG_SEQ
...
-- and local log sequence ARCHIVER_PROCESS_LOG_SEQ
...
IF l_check = 0 THEN
  ...
  l_sql := 'CREATE SEQUENCE ARCHIVER_PROCESS_LOG_SEQ START WITH 1 INCREMENT BY 1';
