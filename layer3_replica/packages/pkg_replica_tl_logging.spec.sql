CREATE OR REPLACE EDITIONABLE PACKAGE PKG_REPLICA_TL_LOGGING --AUTHID CURRENT_USER
authid current_user
AS
...
g_log_sequence_name VARCHAR2(128) := 'REPLICA_PROCESS_LOG_SEQ';
...
g_curr_schema_name VARCHAR2(128);
  ...
  -- Example use #1:
  -- PKG_REPLICA_TL_LOGGING.prc_log( p_log_msg => 'log message');
  --
  -- Example use #2:
  -- DECLARE
  -- l_log_id NUMBER := REPLICA_PROCESS_LOG_SEQ.nextval;
  -- BEGIN
  ...
  -- p_log_sttus => PKG_REPLICA_TL_LOGGING.g_sttus_init_const,
