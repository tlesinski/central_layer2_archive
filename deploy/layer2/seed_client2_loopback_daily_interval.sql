...
PROMPT Seeding CLIENT2 loopback daily interval-list archive table configuration
...
USING (
  SELECT 'CLIENT1_LOOPBACK_LINK' AS source_db_link,
         ...
         'ORDERS_DAILY_INT_SRC_2' AS target_table_name,
  ...
  SELECT 'CLIENT1_LOOPBACK_LINK' AS source_db_link,
    ...
    FROM XMLTABLE(
           ...
           PASSING DBMS_XMLGEN.GETXMLTYPE(
              ...
              'AND table_name = ''ORDERS_DAILY_INT_SRC_2'' ' ||
...
PROMPT CLIENT2 loopback daily interval-list archive table configuration seeded
